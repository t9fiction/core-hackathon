        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              The most secure and user-friendly platform for creating meme tokens with built-in anti-rug pull protection.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.374 0 0 5.373 0 12s5.374 12 12 12 12-5.373 12-12S18.626 0 12 0zm5.568 8.16c-.188 1.982-.891 3.269-.891 3.269-.297 1.271-.743 2.401-1.293 3.33-1.163 1.961-2.872 3.24-5.384 3.24-1.846 0-3.42-.675-4.564-1.77-.185-.178-.089-.49.141-.53.821-.142 1.487-.53 2.014-1.078.527-.548.891-1.254.891-2.06 0-.806-.364-1.512-.891-2.06-.527-.548-1.193-.936-2.014-1.078-.23-.04-.326-.352-.141-.53C6.58 8.676 8.154 8 10 8c2.512 0 4.221 1.279 5.384 3.24z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Token Factory</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Governance</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Liquidity Lock</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Security Guide</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Best Practices</a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              <p className="text-gray-400 text-sm">
                © 2024 PumpFun Factory. All rights reserved.
              </p>
              <div className="flex space-x-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-400">
                Always verify contract addresses before interacting with any token. PumpFun Factory contracts are audited and verified. 
