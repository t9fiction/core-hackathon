  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Mobile: Logo only + Navigation Links */}
        <div className="md:hidden">
          {/* Mobile Logo */}
          <div className="flex justify-center items-center mb-6">
            <div className='bg-blue-600 w-8 h-8 rounded-lg flex items-center justify-center shadow-lg'>
          ...
          {/* Mobile Navigation Links - Multiple columns */}
          <div className="grid grid-cols-2 gap-6 mb-6">
            {/* Platform Links */}
            <div className="text-center">
              <h4 className="text-white font-semibold mb-3">Platform</h4>
              <ul className="space-y-1.5">
                <li><Link href="/deploy" className="text-gray-400 hover:text-white transition-colors text-xs">Token Creation</Link></li>
                <li><Link href="/dex" className="text-gray-400 hover:text-white transition-colors text-xs">DEX Trading</Link></li>
                <li><Link href="/governance" className="text-gray-400 hover:text-white transition-colors text-xs">Governance</Link></li>
                <li><Link href="/tokens" className="text-gray-400 hover:text-white transition-colors text-xs">Token Explorer</Link></li>
                <li><Link href="/token" className="text-gray-400 hover:text-white transition-colors text-xs">Token Manager</Link></li>
              </ul>
            </div>
            ...
            <div className="text-center">
              ...
              <ul className="space-y-1.5">
                <li><Link href="/docs" className="text-gray-400 hover:text-white transition-colors text-xs">Documentation</Link></li>
                <li><a href="https://github.com/chaincraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-xs">GitHub</a></li>
                <li><a href="#security" className="text-gray-400 hover:text-white transition-colors text-xs">Security Guide</a></li>
                <li><a href="#tutorials" className="text-gray-400 hover:text-white transition-colors text-xs">Tutorials</a></li>
                <li><a href="#faq" className="text-gray-400 hover:text-white transition-colors text-xs">FAQs</a></li>
              </ul>
            </div>
          </div>

          {/* Mobile Community - Full width */}
          <div className="text-center mb-6">
            <h4 className="text-white font-semibold mb-3">Community</h4>
            <ul className="flex flex-wrap justify-center gap-x-4 space-y-1">
              <li><a href="https://discord.gg/chaincraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-xs">Discord</a></li>
              <li><a href="https://twitter.com/chaincraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-xs">Twitter</a></li>
              <li><a href="https://t.me/chaincraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-xs">Telegram</a></li>
              <li><a href="mailto:support@chaincraft.io" className="text-gray-400 hover:text-white transition-colors text-xs">Contact Us</a></li>
            </ul>
          </div>
        </div>

        {/* Desktop: Dual-sided layout (Left: Branding, Right: Links) */}
        ...
        <div className="md:hidden flex justify-center gap-4 mt-6 mb-6">
          <a href="https://twitter.com/chaincraft" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
            </svg>
        ...
        {/* Bottom Section */}
        <div className="mt-4 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-800">
