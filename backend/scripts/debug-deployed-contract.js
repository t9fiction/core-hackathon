...
async function main() {
  console.log("=== Debugging Deployed ChainCraftDEXManager ===");
  
  // Your deployed contract address
  const deployedAddress = "0x1a2F32A3F15f7e8B681A26f46C8AC79FecC118ec";
  
  // Get contract instance
  const ChainCraftDEXManager = await ethers.getContractFactory("ChainCraftDEXManager");
  const pumpFunDEXManager = ChainCraftDEXManager.attach(deployedAddress);
