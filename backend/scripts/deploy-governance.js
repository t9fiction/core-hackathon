...
/**
 * Deployment Script for ChainCraft Governance Contracts
 * 
...
async function main() {
  console.log("🚀 Starting ChainCraft Governance Deployment...\n");
  ...
  try {
    ...
    console.log("📝 Deploying ChainCraftGovernance...");
    ...
    console.log("📝 Deploying ChainCraftGovernanceAirdrop...");
    const ChainCraftGovernanceAirdrop = await hre.ethers.getContractFactory("ChainCraftGovernanceAirdrop");
    const airdrop = await ChainCraftGovernanceAirdrop.deploy(governanceAddress);
