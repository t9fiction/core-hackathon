...
describe("ChainCraftFactoryLite (Simplified)", function () {
    let factory;
    let dexManager;
    ...
    describe("Fee Management", function () {
        ...
        it("Should not allow fee above maximum", async function () {
            ...
            ).to.be.revertedWithCustomError(factory, "ChainCraftFactoryLite__InvalidFeeAmount");
        });
    });
    ...
    describe("Token Validation", function () {
        ...
        it("Should revert with supply too low", async function () {
            ...
            ).to.be.revertedWithCustomError(factory, "ChainCraftFactoryLite__TotalSupplyTooLow");
        });
    ...
    describe("Fee Withdrawal", function () {
        ...
        it("Should revert when no funds to withdraw", async function () {
            ...
            await expect(factory.withdrawFees())
                .to.be.revertedWithCustomError(factory, "ChainCraftFactoryLite__NoEtherToWithdraw");
        });
    });
